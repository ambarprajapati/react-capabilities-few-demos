  ...
  render () {
    return (
      <form ref="form" onSubmit={this.onSubmit} className="form-inline">
        <input type="text" ref="titleName" className="form-control" placeholder="Add here...[Assesment 1- submitted by Ambar Prajapati]"/>
...
ReactDOM.render(
<TodoApp initTitles={todoTitles}/>, destination
);
